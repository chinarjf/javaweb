...
public class ModelObject {
  ...
  public boolean isCollide(ModelObject modelObject) {
    return (this.isContainsAPoint(modelObject) || modelObject.isContainsAPoint(this));
  }
...
//    boolean iscollide=false;
    return (modelObject.isPointContains(xPos, yPos) ||
            ...
            modelObject.isPointContains(xPos, yPos + height) ||
            modelObject.isPointContains(xPos + width, yPos + height));
  }
