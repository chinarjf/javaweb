...
//    this.setSize(230, 284);
    this.setBounds( (int) parent.getX() + 20,
                   (int) parent.getY() + 75, 230, 200);
...
class KeyOptionDialog_confirm_actionAdapter
...
class KeyOptionDialog_leftRB_actionAdapter
    implements java.awt.event.ActionListener {
  KeyOptionDialog adaptee;
...
class KeyOptionDialog_rightRB_actionAdapter
    implements java.awt.event.ActionListener {
  KeyOptionDialog adaptee;
