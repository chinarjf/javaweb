...
import javax.swing.*;
import henry.game.*;
import javaman.image.ImageFactory;
import javaman.*;
import javaman.ginterface.*;
public class GameView
    extends JFrame implements IGameControl {
  ...
  private void initCreate() {
    gameoverPanel = new ImagePanel(imageFactory.getImageIcon(
        "images/gameover.gif"));
    pausepanel = new ImagePanel(imageFactory.getImageIcon("images/pause.gif"));
    gameBackground = new ImagePanel(imageFactory.getImageIcon(
        "images/backgroud.gif"));
    lifewordpanel = new ImagePanel(imageFactory.getImageIcon(
        "images/life/lifeword.gif"));
    floorCountpanel = new NumberView(0);
    lifeview = new LifeView(12);
    mainPaintPanel = new GamePaintPanel(gamemodel);
    word1panel = new ImagePanel(imageFactory.getImageIcon(
        "images/word1.gif"));
    word2panel = new ImagePanel(imageFactory.getImageIcon(
        "images/word2.gif"));
