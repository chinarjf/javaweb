...
public class NumberView
    extends JPanel
    implements IFloorCountListener {
  ...
  public void initNumber(int number) {
    ...
    numbers[0].setImage(imageFactory.getImageIcon("images/num/number_" + n0000 +
                                                  ".gif"));
    numbers[1].setImage(imageFactory.getImageIcon("images/num/number_" + n000 +
                                                  ".gif"));
    numbers[2].setImage(imageFactory.getImageIcon("images/num/number_" + n00 +
                                                  ".gif"));
